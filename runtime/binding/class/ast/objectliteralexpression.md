...
|----------------------------------------|------------------------------|-----------------------------------------------|
| export | - | [IObjectLiteralExpression](/runtime/interface/ast/iobjectliteralexpression.md) |
...
|-------------------------------------------|:----------------------------------:|------------------------------|
| public, static, readonly | ✘ | [ObjectLiteralExpression](/runtime/binding/class/ast/objectliteralexpression.md) |

&nbsp;&nbsp; **&#10148; $kind**

| Modifier(s)                               | Optional                           | Type                         |
|-------------------------------------------|:----------------------------------:|------------------------------|
| public, readonly | ✘ | ExpressionKind.ObjectLiteral |
