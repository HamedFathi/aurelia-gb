...
| Type                        |
|-----------------------------|
| (name: string, attrs: Record&lt;string, string&gt; &#124; null, ...children: (string &#124; Node &#124; (string &#124; Node)[])[]) =&gt; HTMLElement |

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; **&#9733; Initializer**

```ts
function (name: string, attrs: Record<string, string> | null, ...children: (Node | string | (Node | string)[])[]) {
