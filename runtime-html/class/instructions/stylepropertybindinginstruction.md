...
|----------------------------------------|------------------------------|-----------------------------------------------|
| export | - | [IStylePropertyBindingInstruction](/runtime-html/interface/definitions/istylepropertybindinginstruction.md) |
...
|-------------------------------------------|:----------------------------------:|------------------------------|
| public | ✘ | HTMLTargetedInstructionType.stylePropertyBinding |